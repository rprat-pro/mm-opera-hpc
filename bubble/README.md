...
N.B. bis: `single_bubble_ci.txt` and `mesh_sphere.msh` are used for GitHub continuous integration. This coarser mesh is generated by `gmsh -3 -clscale 3 single_sphere.geo -o mesh_sphere.msh` (gmsh 4.15.2).
