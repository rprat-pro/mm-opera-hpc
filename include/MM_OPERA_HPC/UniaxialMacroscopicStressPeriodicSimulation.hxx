...
struct MM_OPERA_HPC_EXPORT UniaxialMacroscopicStressPeriodicSimulation {
  /*!
   * \brief numerical parameters used to find both the microscopic micromorphic
   * satisfying the mechanical equilibrium and the macroscopic deformation
   * gradient to find a macroscopic uniaxial tensile stress state
   */
